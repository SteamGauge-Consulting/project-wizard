...
(function () {
  ...
  var CSS = [
    ...
    '.pwe-pills{display:flex;flex-wrap:wrap;gap:6px;padding:14px 20px 0}',
    '.pwe-pill{background:#161618;border:1px solid #2A2A2E;color:#C8C8C2;border-radius:999px;padding:6px 13px;font-size:13px;cursor:pointer}',
    '.pwe-pill:hover{border-color:#3a3a40;color:#fff}',
    '.pwe-pill.on{background:rgba(151,196,89,.14);border-color:#97C459;color:#97C459}',
    '.pwe-pill.done{color:#9A9A95}',

...
function rewriteNav(genDir, ctx) {
  ...
  const navArrowCss = '<style>\n' +
    ...
    '  .docs-nav .nav-step{position:relative;isolation:isolate;display:inline-block;color:#fff;text-decoration:none;font-size:13px;line-height:1;padding:9px 19px 9px 25px;margin-right:-13px;background:#fff;-webkit-clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%,12px 50%);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%,12px 50%);transition:color .12s;}\n' +
    '  .docs-nav .nav-step::before{content:"";position:absolute;inset:1.5px;z-index:-1;background:#000;-webkit-clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%,12px 50%);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%,12px 50%);}\n' +
    '  .docs-nav .nav-step.first{padding-left:16px;-webkit-clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%);}\n' +
    '  .docs-nav .nav-step.first::before{-webkit-clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%);}\n' +
    '  .docs-nav .nav-step:hover{color:#C0DD97;}\n' +
    '  .docs-nav .nav-step.on{color:#0E0E10;font-weight:600;}\n' +
    '  .docs-nav .nav-step.on::before{background:#97C459;}\n' +
    '  .docs-nav .nav-dd>summary.nav-step{border-radius:0;}\n' +
    '  .docs-nav .nav-dd[open]>summary.nav-step{color:#C0DD97;}\n' +
    '</style>';

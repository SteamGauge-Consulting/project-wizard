...
function render(genDir, intake, opts) {
  ...
  const ARCH_SWIM_CSS = '<style>' +
    ...
    '.al-row{display:flex;gap:18px;align-items:stretch;justify-content:center;flex-wrap:wrap;}.al-row.pipe{justify-content:flex-start;}' +
    '.al-node{background:#161618;border:1px solid #3A3A40;border-radius:11px;padding:12px 15px;min-width:150px;max-width:340px;}' +

...
function rewriteNav(genDir, ctx) {
  ...
  const navArrowCss = '<style>\n' +
    ...
    '  .docs-nav .nav-step{display:inline-block;color:#CFD4DE;text-decoration:none;font-size:13px;line-height:1;padding:9px 18px 9px 24px;margin-right:-13px;background:#272f41;-webkit-clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%,12px 50%);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%,12px 50%);transition:background .12s,color .12s;}\n' +
    '  .docs-nav .nav-step.first{padding-left:15px;-webkit-clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 50%,calc(100% - 12px) 100%,0 100%);}\n' +
    '  .docs-nav .nav-step:hover{background:#3a465f;color:#fff;}\n' +
    '  .docs-nav .nav-step.on{background:#4a5670;color:#fff;}\n' +
    '  .docs-nav .nav-dd>summary.nav-step{border-radius:0;}\n' +
    '  .docs-nav .nav-dd>summary.nav-step:hover,.docs-nav .nav-dd[open]>summary.nav-step{background:#3a465f;color:#fff;}\n' +
    '</style>';
  src = src.replace(/const STYLE\s*=\s*"[\s\S]*?";/, 'const STYLE   = ' + JSON.stringify(navArrowCss) + ';');

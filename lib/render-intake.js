...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .mermaid{overflow-x:auto;display:flex;justify-content:center;min-height:60px;}
  .mermaid svg{max-width:100%;height:auto;}
  .gantt-wrap .mermaid{justify-content:flex-start;}
...
function render(genDir, intake, opts) {
  ...
  const MERMAID_HEAD = '<script src="https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.min.js"></script>\n' +
    ...
    'themeVariables:{fontFamily:"-apple-system,system-ui,sans-serif",fontSize:"13px",background:"transparent",' +
    ...
    'titleColor:"#9A9A95"},flowchart:{htmlLabels:true,curve:"basis",nodeSpacing:40,rankSpacing:54,padding:8}});}catch(e){}</script>';

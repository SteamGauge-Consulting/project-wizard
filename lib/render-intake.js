...
function render(genDir, intake, opts) {
  ...
  writeFile(path.join(root, 'architecture.html'), htmlShell(name + ' — architecture', 'The production stack, request flows, and components.', archBody, (diagramHtml ? MERMAID_HEAD : '') + ARCH_PAGE_CSS));

...
function render(genDir, intake, opts) {
  ...
  const buildBody =
    ...
    '<h2>How we track work</h2><div class="grid">' +
      '<div class="card"><div class="k">Tracker</div><h3>Linear</h3><p>Milestones → phases → atomic sub-issues. Each issue&rsquo;s steps are checkboxes you tick as you go.' + (trackerUrl ? ' <a href="' + escA(trackerUrl) + '" target="_blank" rel="noopener">Open the project →</a>' : '') + '</p></div>' +

...
function render(genDir, intake, opts) {
  ...
  const homeBody =
    ...
    statusHtml +
    '<h2>Explore</h2><p class="lead"><a href="/docs/plan">Plan</a> · <a href="/docs/architecture">Architecture</a> · <a href="/docs/build">Build</a> · <a href="/docs/view/' + docsDir + '/REQUIREMENTS.md">Requirements</a> · <a href="/docs/view/' + docsDir + '/DESIGN.md">Design</a></p>' +
